...
// ============================================================================
// Function pointer typedefs for Mono C API exports (trimmed for UI framework)
// ============================================================================
...
typedef MonoVTable* (*mono_class_vtable_fn)(MonoDomain* domain, MonoClass* klass);
typedef void        (*mono_field_static_get_value_fn)(MonoVTable* vt, MonoClassField* field, void* value);

// Type reflection (needed for FindObjectsOfType)
typedef MonoType*   (*mono_class_get_type_fn)(MonoClass* klass);
typedef MonoObject* (*mono_type_get_object_fn)(MonoDomain* domain, MonoType* type);

// Array
typedef uintptr_t   (*mono_array_length_fn)(MonoArray* array);
