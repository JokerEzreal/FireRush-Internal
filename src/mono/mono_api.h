...
namespace mono {
    ...
    // Load mono.dll and resolve all exports.
    ...
    extern mono_class_vtable_fn              class_vtable;
    extern mono_field_static_get_value_fn    field_static_get_value;

    // Type reflection (for FindObjectsOfType)
    extern mono_class_get_type_fn            class_get_type;
    extern mono_type_get_object_fn           type_get_object;

    // Array
    extern mono_array_length_fn              array_length;
