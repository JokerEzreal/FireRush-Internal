...
bool cache_initialize() {
    ...
    // Critical check -- we need GUI and Screen at minimum
    ...
    if (s_classes.GUI) {
        ...
        s_methods.GUI_HorizontalSlider_4 = mono::class_get_method_from_name(s_classes.GUI, "HorizontalSlider", 4);
